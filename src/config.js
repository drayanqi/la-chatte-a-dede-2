export const DEFAULT_CONFIG = {
  ...
  ball: { radius: 7, mass: 1, friction: 0.995, rollingResistance: 0.998, controlCaptureSpeed: 240 },
  physics: { dt: 1/60, aiTickHz: 30, collisionRestitution: 0.7, playerPlayerRestitution: 0.6, maxSubSteps: 5 },
  kick: { maxPower: 960, kickRange: 20, controlRadius: 18, controlStrength: 600, controlTimeoutOnKick: 200 },
